...
export default function Home() {
  return (
    <>
    <div className="max-md:mx-fixed max-sm:mx-auto max-md:mx-0">
    ...
    <div className="w-96 h-72 relative">
        <Image className="left-[-31.25px] top-[55px] absolute" src="/image 48.png" alt="magic" width={100} height={100}/>
        <Image className="left-[157.35px] top-[63.33px] absolute blur-[6.45px]" src="/image 49.png" alt="magic" width={100} height={100} />
        <Image className="left-[-5.59px] top-[142.32px] absolute" src="/image 50.png" alt="magic" width={100} height={100}/>
    </div>
</div>
</section>
      {/* first section end */}
...
<div>
       ...
       <section className='max-md:px-6 max-md:py-[64px] bg-[#BDD5F4]'>
        ...
        <div className='max-md:flex max-md:flex-col max-md:gap-20'>
          <div className='max-md:px-[20px] max-md:py-[10] bg-[#93BBEF] rounded-[25px]'>
            <div className='max-md:flex max-md:justify-between py-7'>
              <div className='max-md:flex max-md:flex-row max-md:gap-2'>
                <div><Image src={'phone.svg'} alt='exm' width={25} height={25}/></div>
                <div className='text-natural-900/80 text-2xl'>Phone</div>
              </div>
              <div className='font-bold text-2xl'>+1 315 308 0901</div>
            </div>
          ...
          <div className='bg-[#DBEBFF] rounded-2xl'>
            ...
            <div><div className='text-lg bg-black text-white max-md:flex max-md:justify-center rounded-full px-[20px] py-[25px]'>
